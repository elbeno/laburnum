...
/*global Interpreter, Tokenizer, List, Word, globalEnv*/
...
function Repeat(env, name) {
  ...
  var e;
  var i;
  var countFn = function () { return new Word(i + 1); };
  env.bindFunction('repcount',
